...
export default function($scope, context) {
    ...
    function showBundle() {
        ...
        if (context.themeSettings.hl_product_layout === 'product_layout_1') {
            cBundle = 'button--secondary'
        } else if (context.themeSettings.hl_product_layout === 'product_layout_2') {
            cBundle = 'button--primary'
        } else {
            cBundle = 'button--tertiary'
        }
        ...
        if($bundle.hasClass('halo-bundle-login')){
            totalBlock = '<div class="halo-product-total">\
                            <a class="button '+cBundle+' halo-product-total-button" disabled href="#"><span>Log in for pricing</span></a>\
                        </div>';
        } else{
            totalBlock = '<div class="halo-product-total">\
                            ...
                            <a class="button '+cBundle+' halo-product-total-button" id="halo-addAll" href="#"><span>Add All To Cart</span></a>\
                        </div>';
        }
    ...
    function showSlickSlider(wrap){
        ...
        if(context.themeSettings.hl_product_layout === 'product_layout_2') {
            sToShow = 3
        } else {
            sToShow = 4
        }
            ...
            wrap.slick({
                ...
                responsive: [
                    ...
                    },
                    {
                        breakpoint: 1025,
                        settings: {
                            slidesToShow: sToShow - 1,
                            slidesToScroll: sToShow - 1,
                            dots: false,
                            arrows: true
                        }
                    },
