                ...
                getProductOption(list).then(data => {
                    ...
                    $.each(list, (idx, item) => {
                        ...
                        if (product_wrapper.find('.slick-cloned').length) {
                            const htmlSwatch = thisProduct.find('.form-field').html();
                            const $formField = product_wrapper.find(`.card[data-product-id="${productId}"] .card-option .form-field`);

                            thisProduct.find('.form-field *').remove();
                            $formField.html(htmlSwatch);
                        }
